 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Pd=E,_d=Symbol.for("react.element"),Nd=Symbol.for("react.fragment"),Rd=Object.prototype.hasOwnProperty,Ld=Pd.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,zd={key:!0,ref:!0,__self:!0,__source:!0};function Au(e,n,t){var r,o={},i=null,l=null;t!==void 0&&(i=""+t),n.key!==void 0&&(i=""+n.key),n.ref!==void 0&&(l=n.ref);for(r in n)Rd.call(n,r)&&!zd.hasOwnProperty(r)&&(o[r]=n[r]);if(e&&e.defaultProps)for(r in n=e.defaultProps,n)o[r]===void 0&&(o[r]=n[r]);return{$$typeof:_d,type:e,key:i,ref:l,props:o,_owner:Ld.current}}yo.Fragment=Nd;yo.jsx=Au;yo.jsxs=Au;(function(e){e.exports=yo})(ud);const Vu=At.Fragment,L=At.jsx,D=At.jsxs;var vi={},gi={},Td={get exports(){return gi},set exports(e){gi=e}},Ee={},yi={},Od={get exports(){return yi},set exports(e){yi=e}},Hu={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function n(_,z){var T=_.length;_.push(z);e:for(;0<T;){var K=T-1>>>1,q=_[K];if(0<o(q,z))_[K]=z,_[T]=q,T=K;else break e}}function t(_){return _.length===0?null:_[0]}function r(_){if(_.length===0)return null;var z=_[0],T=_.pop();if(T!==z){_[0]=T;e:for(var K=0,q=_.length,pr=q>>>1;K<pr;){var En=2*(K+1)-1,Bo=_[En],xn=En+1,hr=_[xn];if(0>o(Bo,T))xn<q&&0>o(hr,Bo)?(_[K]=hr,_[xn]=T,K=xn):(_[K]=Bo,_[En]=T,K=En);else if(xn<q&&0>o(hr,T))_[K]=hr,_[xn]=T,K=xn;else break e}}return z}function o(_,z){var T=_.sortIndex-z.sortIndex;return T!==0?T:_.id-z.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;e.unstable_now=function(){return i.now()}}else{var l=Date,a=l.now();e.unstable_now=function(){return l.now()-a}}var u=[],s=[],f=1,h=null,m=3,g=!1,w=!1,y=!1,R=typeof setTimeout=="function"?setTimeout:null,d=typeof clearTimeout=="function"?clearTimeout:null,c=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function p(_){for(var z=t(s);z!==null;){if(z.callback===null)r(s);else if(z.startTime<=_)r(s),z.sortIndex=z.expirationTime,n(u,z);else break;z=t(s)}}function v(_){if(y=!1,p(_),!w)if(t(u)!==null)w=!0,Uo(k);else{var z=t(s);z!==null&&$o(v,z.startTime-_)}}function k(_,z){w=!1,y&&(y=!1,d(N),N=-1),g=!0;var T=m;try{for(p(z),h=t(u);h!==null&&(!(h.expirationTime>z)||_&&!ze());){var K=h.callback;if(typeof K=="function"){h.callback=null,m=h.priorityLevel;var q=K(h.expirationTime<=z);z=e.unstable_now(),typeof q=="function"?h.callback=q:h===t(u)&&r(u),p(z)}else r(u);h=t(u)}if(h!==null)var pr=!0;else{var En=t(s);En!==null&&$o(v,En.startTime-z),pr=!1}return pr}finally{h=null,m=T,g=!1}}var C=!1,x=null,N=-1,Q=5,I=-1;function ze(){return!(e.unstable_now()-I<Q)}function yt(){if(x!==null){var _=e.unstable_now();I=_;var z=!0;try{z=x(!0,_)}finally{z?wt():(C=!1,x=null)}}else C=!1}var wt;if(typeof c=="function")wt=function(){c(yt)};else if(typeof MessageChannel<"u"){var pa=new MessageChannel,rd=pa.port2;pa.port1.onmessage=yt,wt=function(){rd.postMessage(null)}}else wt=function(){R(yt,0)};function Uo(_){x=_,C||(C=!0,wt())}function $o(_,z){N=R(function(){_(e.unstable_now())},z)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(_){_.callback=null},e.unstable_continueExecution=function(){w||g||(w=!0,Uo(k))},e.unstable_forceFrameRate=function(_){0>_||125<_?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Q=0<_?Math.floor(1e3/_):5},e.unstable_getCurrentPriorityLevel=function(){return m},e.unstable_getFirstCallbackNode=function(){return t(u)},e.unstable_next=function(_){switch(m){case 1:case 2:case 3:var z=3;break;default:z=m}var T=m;m=z;try{return _()}finally{m=T}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(_,z){switch(_){case 1:case 2:case 3:case 4:case 5:break;default:_=3}var T=m;m=_;try{return z()}finally{m=T}},e.unstable_scheduleCallback=function(_,z,T){var K=e.unstable_now();switch(typeof T=="object"&&T!==null?(T=T.delay,T=typeof T=="number"&&0<T?K+T:K):T=K,_){case 1:var q=-1;break;case 2:q=250;break;case 5:q=1073741823;break;case 4:q=1e4;break;default:q=5e3}return q=T+q,_={id:f++,callback:z,priorityLevel:_,startTime:T,expirationTime:q,sortIndex:-1},T>K?(_.sortIndex=T,n(s,_),t(u)===null&&_===t(s)&&(y?(d(N),N=-1):y=!0,$o(v,T-K))):(_.sortIndex=q,n(u,_),w||g||(w=!0,Uo(k))),_},e.unstable_shouldYield=ze,e.unstable_wrapCallback=function(_){var z=m;return function(){var T=m;m=z;try{return _.apply(this,arguments)}finally{m=T}}}})(Hu);(function(e){e.exports=Hu})(Od);/**
 * @license React
...
`,qc=JSON.parse($h),Bh={ingrediente:{id:"id"},comida:{id:"id"},receta:{id:"id"}};let go=new Uh;function Ah(e){console.log(e)}function vl(){return go}function Vh(){qc.map(e=>{go.post("ingrediente",e)})}go.init("comida",2,Bh,Ah).then(()=>{setTimeout(()=>{go.clear("ingrediente").then(()=>{Vh()})},500)});function Hh(){return new Promise(e=>{setTimeout(()=>{e(!0)},201)})}function bc(e){let n=0,t=0,r=0;return e.forEach(o=>{const i=parseFloat(o.proteina),l=parseFloat(o.calorias),a=parseFloat(o.carbohidratos),u=parseFloat(o.cantidad),s=parseFloat(o.usado),f=i*s/u,h=l*s/u,m=a*s/u;n+=isFinite(f)?f:0,r+=isFinite(h)?h:0,t+=isFinite(m)?m:0}),{proteina:Math.round(n),carbohidratos:Math.round(t),calorias:Math.round(r)}}function Wh(e){const[n,t]=E.useState(0),[r,o]=E.useState(0),[i,l]=E.useState(0);function a(){const u=bc(e.listaComida);t(Math.round(u.proteina)),l(Math.round(u.calorias)),o(Math.round(u.carbohidratos))}return E.useEffect(()=>{a()},[e.listaComida]),D("div",{className:"flex-container detalle-comida",children:[D("div",{className:"flex-item amaraillo",children:[L("p",{children:"Calorias:"}),D("h3",{children:[" ",i," cal "]})]}),D("div",{className:"flex-item azul",children:[L("p",{children:"Proteinas:"}),D("h3",{children:[" ",n,"g "]})]}),D("div",{className:"flex-item cafe",children:[L("p",{children:"Carbohidratos:"}),D("h3",{children:[" ",r,"g "]})]})]})}function Qh(e){const[n,t]=E.useState(qc),[r,o]=E.useState([]),[i,l]=E.useState(""),[a,u]=E.useState(45),s=E.useRef(null);function f(g){l(g.target.value)}E.useEffect(()=>{var R;let g=[];n.forEach(d=>{d.nombre.toLowerCase().indexOf(i.toLowerCase())>=0&&g.push(d)}),o(g);const w=(R=s.current)==null?void 0:R.getClientRects()[0].width,y=document.body.getClientRects()[0].width;w&&u((y-w)/2*100/y)},[i]);function h(g){e.seleccionaIngrediente(g)}function m(){return r.map((g,w)=>L("li",{onClick:()=>h(g),children:g.nombre},w))}return D("div",{className:"listar-ingredientes",ref:s,style:{left:a+"%"},children:[L("input",{type:"text",onChange:f,value:i}),L("button",{onClick:()=>e.cancelar(),children:"x"}),L("ul",{children:m()})]})}const gl={ALERT:"w3-red",SUCCESS:"w3-green",WARNING:"w3-yellow"};function Kh(e,n,t){n.addEventListener("click",r=>{clearInterval(t),e.remove()})}const ed={tipo:gl.SUCCESS,titulo:"Título",mensaje:"Mensaje",tiempo:5e3,w3css:"https://www.w3schools.com/w3css/4/w3.css"};function Yh(){return JSON.parse(JSON.stringify(ed))}function Gh(){let e=document.createElement("div");e.id="notificaciones-de-la-app",e.style.cssText="position: fixed; bottom: 0; right: 20px; height: auto; z-index: 10000;";let n=document.querySelector("body");return n&&n.append(e),e}function Tu(e=ed){let n=Object.assign(Yh(),e),t=document.createElement("div");if(t.attachShadow({mode:"open"}),t.style.minWidth="200px",!t.shadowRoot)return;t.shadowRoot.innerHTML=`
    ...
    `;let r=t.shadowRoot.querySelector("span"),o=t.shadowRoot.querySelector("[tiempo]");if(!o)return;let i=0,l=setInterval(h=>{if(i+=10,i>n.tiempo)clearInterval(l),t.remove();else{const m=i/n.tiempo*100;o.style.width=m+"%"}},10);r&&Kh(t,r,l);let a=document.querySelector("#notificaciones-de-la-app");a||(a=Gh());let u=t.shadowRoot.querySelector("#cargando"),s=t.shadowRoot.querySelector("#contenido"),f=t.shadowRoot.querySelector("link");f.onload=()=>{u.remove(),s.style.display="block"},a.appendChild(t)}function Ou(){const[,e]=window.location.href.split("?");if(!e)return{};const n=e.split("&");let t={};return n.forEach(r=>{const[o,i]=r.split("=");t[o]=i}),t}function nd(e){function n(){return e.rutas.map((t,r)=>r+1<e.rutas.length?L(Fo,{to:t.ruta,className:"ruta",children:t.titulo},"index"):D("span",{children:[" ",t.titulo]},r))}return L("div",{className:"breadcrum",children:n()})}class td{constructor(n=[]){An(this,"pasos");An(this,"ipaso");An(this,"div");An(this,"pico");An(this,"divBack");this.pasos=n,this.ipaso=-1,this.div=null,this.pico=null,this.divBack=null}inicia(){this.ipaso=0,this.render()}addPaso(n){this.pasos.push(n)}atras(){this.ipaso--,this.render()}siguiente(){this.ipaso++,this.render()}esActivo(){return!!this.div}remueve(){this.div&&this.pico&&this.divBack&&(this.div.remove(),this.pico.remove(),this.divBack.remove()),this.div=null,this.pico=null,this.divBack=null}cancelar(){this.remueve()}render(){if(this.div&&this.remueve(),this.ipaso==-1||this.ipaso>=this.pasos.length)return;this.div=document.createElement("div"),this.div.classList.add("_modal_tour"),this.pico=document.createElement("div"),this.divBack=document.createElement("div"),this.divBack.classList.add("tour-back");const n=this.pasos[this.ipaso];n.posicion=="top"?this.pico.classList.add("_flecha-abajo"):this.pico.classList.add("_flecha-arriba"),document.body.append(this.divBack),document.body.append(this.div),document.body.append(this.pico),this.div.innerHTML=n.contenido;let t=document.querySelector(n.target);const r=t.getClientRects(),[o,i,l,a]=[r[0].top,r[0].left,r[0].width,r[0].height];this.addBotones(this.div,n),this.addListenersBotones(this.div),Object.assign(this.div.style,{top:o+"px",left:1+"px",height:"auto",maxWidth:"300px",position:"absolute",background:"white",zIndex:2001,visibility:"hidden",borderRadius:"5px"});let u=o-21;n.posicion=="botton"&&(u=o+a),Object.assign(this.pico.style,{top:u+"px",left:i+l/2-5+"px",position:"absolute",zIndex:2001});let s=this.div.clientWidth,f=i+l/2-s/2;f+s>document.body.clientWidth?f=i+l-s+5:f<0&&(f=i);let h=o-this.div.clientHeight-20;n.posicion!="top"&&(h=a+o+10),Object.assign(this.div.style,{top:h+"px",left:f+"px",visibility:""}),console.log(o,h,t.getClientRects()),this.mueveScroll(o-2*this.div.clientHeight)}addBotones(n,t){let r="";t.acciones.forEach(o=>{const i=o.class?' class="'+o.class+'"':"";r+=`<button ${i}>${o.texto}</button>`}),n.innerHTML+=`
        <div class='_botones'>
            ${r}
        </div>
        ...
        <p>Por último guardamos</p>`,target:"#guardar",posicion:"top",acciones:[{texto:"atras",accion:ue.atras,class:"azul"},{texto:"finalizar",accion:ue.siguiente,class:"rojo"}]};ue.addPaso(Xh);ue.addPaso(Jh);ue.addPaso(Zh);ue.addPaso(qh);ue.addPaso(bh);function em(){const e=localStorage.getItem("tourReceta");ue.esActivo()||e||(ue.inicia(),localStorage.setItem("tourReceta","true"))}function nm(){const[e,n]=E.useState(!1),[t,r]=E.useState("Sin nombre"),[o,i]=E.useState(""),[l,a]=E.useState([]),[u,s]=E.useState([{titulo:"Recetas",ruta:"/"}]),f=Jc();E.useEffect(()=>{em();let v=_n(u);const k=parseInt(Ou().id);if(!k){v.push({titulo:"Receta Nueva",ruta:"/receta"}),s(v);return}vl().get("receta",k).then(x=>{x&&(v.push({titulo:x.nombre,ruta:"/receta?id="+k}),s(v),r(x.nombre),a(x.ingredientes),i(x.preparacion))})},[]);function h(){n(!0)}function m(v){const k=l.find(N=>N.id==v.id);if(k){let N=parseInt(v.cantidad)+parseInt(k.usado);w(v.id,N),n(!1);return}let C=_n(l),x=_n(v);x.usado=x.cantidad,C.push(x),a(C),n(!1)}function g(){n(!1)}function w(v,k){let C=_n(l),x=C.find(N=>N.id==v);x&&(x.usado=k,a(C))}function y(v){let k=_n(l),C=k.findIndex(x=>x.id==v);C>-1&&(k.splice(C,1),a(k))}function R(){return l.map(v=>D("tr",{children:[L("td",{children:v.nombre}),D("td",{children:[L("input",{value:v.usado,type:"number",onChange:k=>w(v.id,k.target.value)}),v.medida,L("button",{onClick:()=>y(v.id),children:"x"})]})]},v.id))}function d(){if(console.log(t),!t||t=="Sin nombre"||t==""){Tu({titulo:"Error",tipo:gl.ALERT,mensaje:"Pon el nombre de la receta"});return}const v=vl(),k=parseInt(Ou().id);let C,x={nombre:t+"",ingredientes:_n(l),preparacion:o+""};k?(C=v.put.bind(v),x.id=k):C=v.post.bind(v),C("receta",x).then(N=>{Tu({tipo:gl.SUCCESS,titulo:"Success",mensaje:"Se agrego la receta: "+t}),f("/receta?id="+N.id)})}function c(v){v.target.value?r(v.target.value):r("")}function p(v){v.target.value?i(v.target.value):i("")}return D("div",{className:"Receta",children:[L(nd,{rutas:u}),D("div",{className:"centrar",children:[D("h2",{children:["Receta ",L("input",{type:"text",value:t,onChange:c,id:"nombre-receta"})]}),L(Wh,{listaComida:l}),L("button",{onClick:()=>h(),className:"boton",id:"agregar-ingrediente",children:"Agregar Ingrediente"}),e?L(Qh,{seleccionaIngrediente:m,cancelar:g}):L(Vu,{}),D("table",{className:"tabla-receta",children:[L("thead",{children:D("tr",{children:[L("th",{children:"Ingrediente"}),L("th",{children:"Cantidad"})]})}),L("tbody",{children:R()})]}),L("h3",{children:"Preparación"}),L("textarea",{value:o,onChange:p,id:"preparacion"}),L("div",{className:"ancho-100",children:L("button",{onClick:()=>d(),className:"der boton",id:"guardar",children:"Guardar"})})]})]})}function tm(){return D("div",{className:"menu",children:[L(Fo,{to:"/",className:"item btn",children:L("i",{className:"bi bi-house-fill"})}),L("div",{className:"item",children:"Recetario"})]})}function rm(e){return L("div",{className:"body-splash",onClick:()=>e.click(),children:L("h2",{className:"titulo-inicial",children:"Recetas"})})}function om(e){const[n,t]=E.useState({proteina:0,calorias:0,carbohidratos:0});return E.useEffect(()=>{t(bc(e.receta.ingredientes))},[]),D(Fo,{className:"tarjeta-receta",to:"/receta?id="+e.receta.id,children:[L("h3",{children:e.receta.nombre}),D("div",{className:"detalles",children:[L("p",{children:D("span",{className:"letra letra_caloria",children:[n.calorias," "]})}),D("span",{className:"letra letra_proteina",children:["p: ",n.proteina," "]}),D("span",{className:"letra letra_carbohidrato",children:["c: ",n.carbohidratos]})]})]})}const On=new td;On.addPaso({contenido:`
        <h2>🤔</h2>
        <p>
        Veo que es la primera vez que entras, 
        a continución te explico lo básico</p>`,target:".breadcrum",posicion:"botton",acciones:[{texto:"siguiente",accion:On.siguiente,class:"azul"}]});On.addPaso({contenido:`
    <p>Primero tienes que agregar una receta</p>`,target:".boton-circular",acciones:[{texto:"atras",accion:On.atras,class:"azul"},{texto:"siguiente",accion:On.siguiente,class:"azul"}],posicion:"botton"});function im(){const e=localStorage.getItem("tourRecetario");On.esActivo()||e||(On.inicia(),localStorage.setItem("tourRecetario","true"))}const lm=vl();function am(){const[e,n]=E.useState([]),[t,r]=E.useState([{titulo:"Recetas",ruta:"/"}]);return E.useEffect(()=>{Hh().then(()=>{lm.list("receta").then(o=>{n(_n(o))})}),im()},[]),D("div",{children:[L(nd,{rutas:t}),D("div",{children:[L(Fo,{to:"/receta",className:"boton boton-circular derecha",children:"+"}),L("div",{className:"tarjetario",children:e.map((o,i)=>L(om,{receta:o},i))})]})]})}function um(){const[e,n]=E.useState(!0);function t(){return e?L(rm,{click:()=>n(!1)}):D(jh,{children:[L(tm,{}),D(Lh,{children:[L(pl,{path:"/receta",element:L(nm,{})}),L(pl,{path:"/",element:L(am,{})})]}),L("div",{className:"espacio"})]})}return L(Vu,{children:t()})}vi.createRoot(document.getElementById("root")).render(L(Bu.StrictMode,{children:L(um,{})}));
